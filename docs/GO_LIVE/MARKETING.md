# Raising Atlantic Go-Live: `MARKETING` View

> Role-focused subset of [GO_LIVE.md](../GO_LIVE.md) for the `MARKETING` role. Section numbers and links reference the source document; use them to back-reference full context.

**Role definition:** Copy, press, launch announcement, content calendar, partner outreach (paediatric associations).

**Phase involvement:**

- [Phase 8: Email, SMS & Notifications](#phase-8-email-sms--notifications): `MARKETING 25%`
- [Phase 13: Launch & Marketing](#phase-13-launch--marketing): `MARKETING 50%`

---

## TL;DR: Phased Action Plan

A focused subset of the launch plan for the `MARKETING` role. Each tier preserves the original 5min-read structure of [GO_LIVE.md](../GO_LIVE.md#tldr-phased-action-plan); items not applicable to `MARKETING` are marked N/A.
...
Each section below corresponds to a numbered phase in the [source document](../GO_LIVE.md). Phases without a `MARKETING` share are marked N/A with a back-link.
