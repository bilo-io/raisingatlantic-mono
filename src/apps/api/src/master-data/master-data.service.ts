...
export class MasterDataService {
      ...
      milestones: [
        {
          ...
          description: 'Begins to smile at people',
        },
        {
          id: 'm_2mo_soc_2',
          category: 'Social/Emotional',
          description: 'Can briefly calm himself (may bring hands to mouth)',
        },
        {
          id: 'm_2mo_lan_1',
          category: 'Language/Communication',
          description: 'Coos, makes gurgling sounds',
        },
        {
          id: 'm_2mo_mot_1',
    ...
    },
    {
      ...
      milestones: [
        ...
        },
        {
          id: 'm_4mo_lan_1',
          category: 'Language/Communication',
          description: 'Babbles with expression and copies sounds he hears',
        },
        {
          id: 'm_4mo_cog_1',
          category: 'Cognitive',
    ...
    },
    {
      ...
      milestones: [
        ...
        },
        {
          id: 'm_6mo_lan_1',
          category: 'Language/Communication',
          description: 'Responds to sounds by making sounds',
        },
        {
          id: 'm_6mo_cog_1',
          category: 'Cognitive',
      ...
      milestones: [
        {
          id: 'm_9mo_soc_1',
          category: 'Social/Emotional',
          description: 'May be afraid of strangers',
        },
        {
          id: 'm_9mo_lan_1',
          category: 'Language/Communication',
        ...
        },
        {
          id: 'm_9mo_cog_1',
          category: 'Cognitive',
          description: 'Plays peek-a-boo',
        },
        {
          id: 'm_9mo_mot_1',
          category: 'Movement/Physical',
          description: 'Pulls to stand, holding on',
        },
      ],
    },
    {
      ...
      milestones: [
        {
          id: 'm_1yr_soc_1',
          category: 'Social/Emotional',
          description: 'Is shy or nervous with strangers',
        },
        {
          id: 'm_1yr_lan_1',
          category: 'Language/Communication',
          description: 'Says "mama" and "dada" and exclamations like "uh-oh!"',
        },
        {
          id: 'm_1yr_cog_1',
          category: 'Cognitive',
          description: 'Copies gestures',
        },
        {
          id: 'm_1yr_mot_1',
          category: 'Movement/Physical',
          description: 'May take a few steps without holding on',
        },
      ],
    },
    {
      ...
      milestones: [
        ...
        },
        {
          id: 'm_18mo_cog_1',
          category: 'Cognitive',
          description: 'Points to one body part',
        },
        {
          id: 'm_18mo_mot_1',
          category: 'Movement/Physical',
      ...
      milestones: [
        {
          id: 'm_2yr_soc_1',
          category: 'Social/Emotional',
          description: 'Gets excited when with other children',
        },
        {
          id: 'm_2yr_lan_1',
          category: 'Language/Communication',
          description: 'Knows names of familiar people and body parts',
        },
        {
          id: 'm_2yr_cog_1',
          category: 'Cognitive',
          description: 'Begins to sort shapes and colors',
        },
        {
          id: 'm_2yr_mot_1',
          category: 'Movement/Physical',
      ...
      milestones: [
        {
          id: 'm_3yr_soc_1',
          category: 'Social/Emotional',
          description: 'Shows a wide range of emotions',
        },
        {
          id: 'm_3yr_lan_1',
          category: 'Language/Communication',
          description: 'Follows instructions with 2 or 3 steps',
        },
        {
          id: 'm_3yr_cog_1',
          category: 'Cognitive',
          description: 'Can work toys with buttons, levers, and moving parts',
        },
        {
          id: 'm_3yr_mot_1',
          category: 'Movement/Physical',
      ...
      milestones: [
        {
          id: 'm_4yr_soc_1',
          category: 'Social/Emotional',
          description: 'Would rather play with other children than by himself',
        },
        {
          id: 'm_4yr_lan_1',
          category: 'Language/Communication',
        ...
        },
        {
          id: 'm_4yr_cog_1',
          category: 'Cognitive',
          description: 'Names some colors and some numbers',
        },
        {
          id: 'm_4yr_mot_1',
          category: 'Movement/Physical',
          description: 'Hops and stands on one foot up to 2 seconds',
        },
      ],
    },
    {
      ...
      milestones: [
        {
          id: 'm_5yr_soc_1',
          category: 'Social/Emotional',
          description: 'Wants to be like friends',
        },
        {
          id: 'm_5yr_lan_1',
          category: 'Language/Communication',
          description: 'Speaks very clearly',
        },
        {
          id: 'm_5yr_cog_1',
          category: 'Cognitive',
          description: 'Counts 10 or more things',
        },
        {
          id: 'm_5yr_mot_1',
          category: 'Movement/Physical',
          description: 'Can do a somersault',
        },
      ],
    },
  ];
  ...
  private readonly vaccinations: Vaccination[] = [
    ...
    },
    {
      id: 'flu',
      name: 'Influenza (Flu)',
      recommendedAge: 'Annually starting at 6 Months',
      doseInfo: 'Yearly',
    },
    {
      id: 'mmr1',
    ...
    },
    {
      ...
      doseInfo: '1st dose (2-dose series)',
    },
    {
      id: 'dtap4',
      name: 'DTaP',
